...
void setup(void) {
  ...
  uint8_t card23[] =  { 0x4, 0x76, 0x35, 0xFA, 0x3C, 0x61, 0x80 }; //card 23 Rina
  uint8_t card24[] =  { 0x4, 0x54, 0x27, 0xAA, 0xE8, 0x5B, 0x80 }; //card 24 Rizal
  uint8_t card25[] =  { 0x4, 0x29, 0x42, 0x62, 0xBE, 0x53, 0x80 }; //card 25 sadam
